...
CREATE TABLE TBL_PRIMARY (
    ID NUMBER GENERATED ALWAYS AS IDENTITY PRIMARY KEY -- 데이터 분류를 위한 번호 자동 값 증가
    , USER_ID VARCHAR2(20) UNIQUE 
    , USER_PW VARCHAR2(20) NOT NULL
    , USER_TEL VARCHAR2(13) 
);

DROP TABLE TBL_PRIMARY;

-- 데이터 값 넣기
INSERT INTO TBL_PRIMARY (USER_ID, USER_PW)
VALUES ('su2', 'pw');
